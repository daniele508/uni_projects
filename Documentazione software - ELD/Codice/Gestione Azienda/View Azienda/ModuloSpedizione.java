 ...
 * @author laura
 */
public class ModuloSpedizione extends javax.swing.JFrame {

    /**
     * Creates new form ModuloScarico
     */
    public ModuloSpedizione(int idUtente, Collection<Object> row, ControlOrdina control) {
        this.idUtente=idUtente;
        this.datiRiepilogativi=row;
        this.controlOrdina=control;
        initComponents();
    ...
    private void initComponents() {
        ...
        pulsanteSpedisci = new javax.swing.JButton();
        ...
        pulsanteSpedisci.setBackground(new java.awt.Color(0, 102, 0));
        pulsanteSpedisci.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        pulsanteSpedisci.setForeground(new java.awt.Color(255, 255, 255));
        pulsanteSpedisci.setText("Spedisci");
        pulsanteSpedisci.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                spedisci(evt);
            }
        });
        ...
        jLabel1.setText("Modulo Spedizione");
    ...
    private void spedisci(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        this.compila();
        this.controlOrdina.riepilogo();
        this.dispose();
    }//GEN-LAST:event_jButton2ActionPerformed

    public void compila(){
        this.controlOrdina.setDati(this.getDati());
    }

    public String[] getDati(){
        String dati[]=new String[2];
        dati[0]=String.valueOf(this.jTable1.getValueAt(0,3));
        dati[1]=String.valueOf(this.jTable1.getValueAt(0,4));
        return dati;
    }
    ...
    private javax.swing.JButton pulsanteSpedisci;
