 ...
 * @author laura
 */
public class ModuloCarico extends javax.swing.JFrame {

    /**
     * Creates new form ModuloScarico
     */
    public ModuloCarico(Collection<Object> datiRiepilogativi, int idUtente, ControlCarico controlCarico) {
        this.datiRiepilogativi=datiRiepilogativi;
        this.idUtente=idUtente;
        this.controlCarico=controlCarico;
        initComponents();
    ...
    private void initComponents() {
        ...
        pulsanteCarica.setBackground(new java.awt.Color(0, 102, 0));
        pulsanteCarica.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        pulsanteCarica.setForeground(new java.awt.Color(255, 255, 255));
        pulsanteCarica.setText("Carica");
    ...
    public void carica(java.awt.event.ActionEvent evt){
        this.compila();
        this.controlCarico.run();
        this.dispose();
    }

    public void compila(){
        this.controlCarico.setDati(this.getDati());
    }

    public String[] getDati(){
        String dati[]= new String[2];
        dati[0]=(String)this.jTable1.getValueAt(0,3);
        dati[1]=(String)this.jTable1.getValueAt(0,4);
        return dati;
    }
