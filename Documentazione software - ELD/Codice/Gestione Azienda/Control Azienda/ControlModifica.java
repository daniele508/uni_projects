...
public class ControlModifica {
    private ModuloModifica moduloModifica;
    ...
    public ControlModifica(int idUtente, Collection<Object> row){
        this.idUtente=idUtente;
        this.datiRiepilogativi=row;
        this.lista=new ArrayList<Object[]>();
        this.moduloModifica=new ModuloModifica(this.datiRiepilogativi, this.idUtente, this);
    }
    ...
    public void riepilogo(){
        this.datiRiepilogativi.add(this.dati);
    ...
    public void run(){
        ...
        try{
            ...
            this.query="update Prenota set Quantità="+this.dati+" where ID="+String.valueOf(this.datiRiepilogativi.toArray()[0])+"; update Ordina set Quantità="+this.dati+" where ID="+String.valueOf(this.datiRiepilogativi.toArray()[0])+" and IDfarmacia="+String.valueOf(this.datiRiepilogativi.toArray()[1]);
